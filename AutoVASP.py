...
job_types: dict = {
    ...
    "slab_relaxation_high_prec": {"System": "AutoVASP High Precision Slab Relaxation", "PREC": "Accurate", "ENCUT": "520", "ISTART": "0", "ICHARG": "2", "ISPIN": "1", "NELM": "60", "NELMIN": "3", "NELMDL": "10", "EDIFF": "1.0E-07", "LREAL": "Auto", "VOSKOWN": "1",  "EDIFFG": "-1.0E-05", "NSW": "90", "IBRION": "2", "ISIF": "2", "SIGMA": "0.10", "ISMEAR": "0"},
...
def primitive_from_mpicode(mpcode: str, api_key: str, is_conventional: bool = False) -> Structure:
    '''
...
def slabs_from_structure(structure: Structure, miller_index: list[int], min_slab_size: float = 15.0, min_vacuum_size: float = 15.0, use_in_unit_planes: bool = False, ensure_symmetric_slabs: bool = True, min_z: int = 5, is_conventional: bool = True) -> list[Structure]:
    '''
...
def primtive_slabs_from_structure(structure: Structure, miller_index: list[int], min_slab_size: float = 15.0, min_vacuum_size: float = 15.0, use_in_unit_planes: bool = False, ensure_symmetric_slabs: bool = True, min_z: int = 5, is_conventional: bool = False) -> list[Structure]:
    '''
    Function to generate slabs from a structure
    '''
